...
namespace Shared.Modules.Pages.RekeningListrik
{
	public class RekeningListrikDetail : ContentPage
	{	
		string strUid, strUname, strTglBayar, strBulan, strTahun, strNmpasar, strKdpasar, 
		strAlamat, strNmped, strDaya, strAwal, strAkhir, strPakai, strBiaya, strBeban, strTtlb, strPpj, strJasa, strBtu, strMaterai, strPpn, strTotal;
		ScrollView scroll;
		StackLayout headerLayout, lblTglBayar, lblPeriode, lblPasar, lblStand, lblPedagang, lblDaya, lblPemakaian, lblBiaya, 
		lblBeban, lblTtlb, lblPpj, lblPemeliharaan, lblBtu, lblMaterai, lblPPn, lblTotal, allLayout, btnCetak;
		cxLabel txtUid, txtUname, txtTglBayar, txtBulan, txtTahun, txtNmpasar, txtKdpasar, txtAlamat, txtNmped, txtDaya, txtAwal, txtAkhir, 
		txtPakai, txtBiaya, txtBeban, txtTtlb, txtPpj, txtJasa, txtBtu, txtMaterai, txtPpn, txtTotal;

		public RekeningListrikDetail (string pageTitle, string tahun, string bulan, string pasar, string nmpasar, string nmped, string alamat, string daya, string awal, string akhir, string pakai, string biaya, string beban, string ttlb, string ppj, string jasa, string btu, string materai, string ppn, string total, string tglbayar, string uid, string uname)
		{
			try
			{
				Title = pageTitle;
		...
		protected override void OnAppearing ()
		{
			try
			{
				...
				if(strDaya == null || strDaya.Length <= 1){
					txtDaya.Text = " 0 ";
				}
				...
				if(strBeban == null || strBeban.Length <= 1){
					txtBeban.Text = " 0 ";
				}
				if(strTtlb == null || strTtlb.Length <= 1){
					txtTtlb.Text = " 0 ";
				}
				if(strPpj == null || strPpj.Length <= 1){
					txtPpj.Text = " 0 ";
				}
