...
[assembly: ExportRenderer (typeof (cxDatePicker), typeof (cxDatePickerRenderer))]
public class cxDatePickerRenderer : DatePickerRenderer
{
#if __ANDROID__
	...
	void UpdateUi(cxDatePicker view)
	{
		try{
    ...
    protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
    {
		try{
	        ...
	        var view = Element as cxDatePicker;

	        if (view != null &&
	            e.PropertyName == cxDatePicker.FontFamilyProperty.PropertyName ||
	            e.PropertyName == cxDatePicker.FontSizeProperty.PropertyName ||
	            e.PropertyName == cxDatePicker.AlignmentProperty.PropertyName ||
	            e.PropertyName == cxDatePicker.TextColorProperty.PropertyName)
	        {
	            SetView(view);
	        }
		}
