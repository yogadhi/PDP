...
[assembly: ExportRenderer (typeof (cxTimePicker), typeof (cxTimePickerRenderer))]
public class cxTimePickerRenderer : TimePickerRenderer
{
#if __ANDROID__
	...
	void UpdateUi(cxTimePicker view)
	{
		try{
    ...
    protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.TimePicker> e)
    {
		try{
	        ...
	        var view = e.NewElement as cxTimePicker;
    ...
    protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
    {
		try{
	        ...
	        var view = Element as cxTimePicker;

	        if (view != null &&
	            e.PropertyName == cxTimePicker.FontFamilyProperty.PropertyName ||
	            e.PropertyName == cxTimePicker.FontSizeProperty.PropertyName ||
	            e.PropertyName == cxTimePicker.AlignmentProperty.PropertyName ||
	            e.PropertyName == cxTimePicker.TextColorProperty.PropertyName)
	        {
	            SetView(view);
	        }
		}
    ...
    private void UpdateUi(cxTimePicker view)
    {
		try{
	        if (view.FontSize > 0)
	        {
    ...
    private void SetBorder(cxTimePicker view)
    {
		try{
    ...
    private void SetView(cxTimePicker view)
    {
		try{
	        if (view == null)
	        {
